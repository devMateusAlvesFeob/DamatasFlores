...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Aniversario(), // Inicializa a classe amor
    );
  }
}

class Aniversario extends StatelessWidget {
  const Aniversario({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color.fromARGB(255, 255, 230, 0), //cor do fundo
        title: Text(
          "Aniversários",
      ...
      body: PageView(
        children: [
          //filhos
          ProductCard(
            title: "Orquídea phalaenopsis Lilas no aquário de vidro",
            description:
                "Uma linda orquídea lilas para decorar a casa e presentear alguém especial no aniversário.",
            price: "\$249.00",
            imageUrl:
                "assets/images/amor3.png", //caminho da imagem 2 dentro do projeto
          ),
        ],
      ),
    );
